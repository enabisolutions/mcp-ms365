...
function buildGeneralMcpInstructions(opts: McpInstructionsContext): string {
  const parts = [
    ...
    "Calendar events: create-calendar-event and create-specific-calendar-event auto-add a Microsoft Teams meeting link (isOnlineMeeting=true, onlineMeetingProvider='teamsForBusiness') unless the body explicitly sets isOnlineMeeting: false. To create an event without a Teams link, pass isOnlineMeeting: false in the body.",
